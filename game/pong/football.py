...
y_d = 100
all_player =[]
player = Player((relative,20),10,(255,255,255))
player_1 = Player((relative - 2*x_d,y_d),10,(0,0,255))
player_2 = Player((relative,y_d),10,(0,0,255))
player_3 = Player((relative + 2*x_d,y_d),10,(0,0,255))
player_4 = Player((relative - x_d,2*y_d),10,(0,0,255))
player_5 = Player((relative + x_d,2*y_d),10,(0,0,255))
player_ball = Player((relative + x_d,500),10,(0,255,0))
